...
print("El total de celulas que hay en el set de test es ", total_celulas_test,"\n",    "La cantidad de plaquetas que hay en el set completo de test es ", test_cant_Platelets,  "representando un",p_test_P,"%"," sobre el total de las celulas que hay en test y un ",p_test_total_P,"%",  " sobre el total \n",  "La cantidad de globulos rojos que hay en el set completo de test es ", test_cant_RBC ,  "representando un",p_test_R,"%"," sobre el total de las celulas que hay en test y un ",p_test_total_R,"%",  " sobre el total \n",  "La cantidad de globulos blancos que hay en el set completo de test es ", test_cant_WBC ,  "representando un",p_test_W,"%"," sobre el total de las celulas que hay en test y un ",p_test_total_W,"%",  " sobre el total \n \n",  "El total de celulas que hay en el set de train es ", total_celulas_train,"\n",  "La cantidad de plaquetas que hay en el set completo de train es ", train_cant_Platelets,  "representando un",p_train_P,"%"," sobre el total de las celulas que hay en train y un ",p_train_total_P,"%",  " sobre el total \n",  "La cantidad de globulos rojos que hay en el set completo de train es ", train_cant_RBC ,  "representando un",p_train_R,"%"," sobre el total de las celulas que hay en train y un ",p_train_total_R,"%"," sobre el total \n","La cantidad de globulos blancos que hay en el set completo de train es ", train_cant_WBC ,"representando un",p_train_W,"%"," sobre el total de las celulas que hay en train y un ",p_train_total_W,"%"," sobre el total \n \n","El total de celulas que hay en el set de valid es ", total_celulas_valid,"\n","La cantidad de plaquetas que hay en el set completo de valid es ", valid_cant_Platelets,"representando un",p_valid_P,"%"," sobre el total de las celulas que hay en train y un ",p_valid_total_P,"%"," sobre el total \n","La cantidad de globulos rojos que hay en el set completo de valid es ", valid_cant_RBC ,"representando un",p_valid_R,"%"," sobre el total de las celulas que hay en train y un ",p_valid_total_R,"%"," sobre el total \n","La cantidad de globulos blancos que hay en el set completo de valid es ", valid_cant_WBC ,"representando un",p_valid_W,"%"," sobre el total de las celulas que hay en train y un ",p_valid_total_W,"%"," sobre el total \n \n","El total de celulas que hay en el total de las imagenes (totoal general) es ", total_celulas,"\n \n")
